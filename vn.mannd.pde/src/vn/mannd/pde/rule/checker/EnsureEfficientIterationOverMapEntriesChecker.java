...
public class EnsureEfficientIterationOverMapEntriesChecker extends ConditionalChecker
{
	...
	public EnsureEfficientIterationOverMapEntriesChecker(CompositeParameter parameter)
	...
	{
		// Checks this method is get() or not

		final IMethodBinding binding = methodInvocation.resolveMethodBinding();
		if (!binding.getName().equalsIgnoreCase(GET_METHOD_NAME))
		{
			return false;
		}
