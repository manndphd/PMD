...
import vn.mannd.pde.rule.checker.UnserializeableClassChecker;
import vn.mannd.pde.rule.checker.core.ConditionalChecker;

public class UnserializeableClassAnalyzer extends RuleAnalyzer
{

	public UnserializeableClassAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final TypeDeclaration typeDecl : typeDecls)
		{
			...
			final UnserializeableClassChecker checker =
				new UnserializeableClassChecker(parameter);
