...
import vn.dongpv.pde.rule.checker.DoNotSubclassClassLoaderChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class DoNotSubclassClassLoaderAnalyzer extends RuleAnalyzer
{

	public DoNotSubclassClassLoaderAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final TypeDeclaration typeDecl : typeDecls)
		{
			...
			final DoNotSubclassClassLoaderChecker checker =
				new DoNotSubclassClassLoaderChecker(parameter);
