...
import vn.dongpv.pde.rule.checker.DefineInitialCapacitiesChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class DefineInitialCapacitiesAnalyzer extends RuleAnalyzer
{

	public DefineInitialCapacitiesAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final ClassInstanceCreation creation : creations)
		{
			...
			final DefineInitialCapacitiesChecker checker =
				new DefineInitialCapacitiesChecker(parameter);
