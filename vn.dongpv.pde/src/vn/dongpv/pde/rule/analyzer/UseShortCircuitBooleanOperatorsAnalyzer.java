...
import vn.dongpv.pde.rule.checker.UseShortCircuitBooleanOperatorsChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class UseShortCircuitBooleanOperatorsAnalyzer extends RuleAnalyzer
{

	public UseShortCircuitBooleanOperatorsAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final InfixExpression expression : expressions)
		{
			...
			final UseShortCircuitBooleanOperatorsChecker checker =
				new UseShortCircuitBooleanOperatorsChecker(parameter);
