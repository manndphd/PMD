...
import vn.dongpv.pde.rule.checker.EnsureEfficientRemovalOfElementsInCollectionChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class EnsureEfficientRemovalOfElementsInCollectionAnalyzer extends RuleAnalyzer
{

	public EnsureEfficientRemovalOfElementsInCollectionAnalyzer(
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final EnsureEfficientRemovalOfElementsInCollectionChecker checker =
				new EnsureEfficientRemovalOfElementsInCollectionChecker(parameter);
