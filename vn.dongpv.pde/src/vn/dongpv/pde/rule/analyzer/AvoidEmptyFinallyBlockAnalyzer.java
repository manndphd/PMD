...
import vn.dongpv.pde.rule.checker.AvoidEmptyFinallyBlockChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidEmptyFinallyBlockAnalyzer extends RuleAnalyzer
{

	public AvoidEmptyFinallyBlockAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final TryStatement tryStatement : tryStatements)
		{
			...
			final AvoidEmptyFinallyBlockChecker checker =
				new AvoidEmptyFinallyBlockChecker(parameter);
