...
import vn.dongpv.pde.rule.checker.FinalizeShouldNotBePublicChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class FinalizeShouldNotBePublicAnalyzer extends RuleAnalyzer
{

	public FinalizeShouldNotBePublicAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodDeclaration methodDecl : methodDecls)
		{
			...
			final FinalizeShouldNotBePublicChecker checker =
				new FinalizeShouldNotBePublicChecker(parameter);
