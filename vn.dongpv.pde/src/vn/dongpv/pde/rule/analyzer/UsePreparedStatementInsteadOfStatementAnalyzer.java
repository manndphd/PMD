...
import vn.dongpv.pde.rule.checker.UsePreparedStatementInsteadOfStatementChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class UsePreparedStatementInsteadOfStatementAnalyzer extends RuleAnalyzer
{

	public UsePreparedStatementInsteadOfStatementAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final ASTNode varDecl : decls)
		{
			...
			final UsePreparedStatementInsteadOfStatementChecker checker =
				new UsePreparedStatementInsteadOfStatementChecker(parameter);
