...
import vn.dongpv.pde.rule.checker.EnsureEfficientRemovalOfMapEntriesChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class EnsureEfficientRemovalOfMapEntriesAnalyzer extends RuleAnalyzer
{

	public EnsureEfficientRemovalOfMapEntriesAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final EnsureEfficientRemovalOfMapEntriesChecker checker =
				new EnsureEfficientRemovalOfMapEntriesChecker(parameter);
