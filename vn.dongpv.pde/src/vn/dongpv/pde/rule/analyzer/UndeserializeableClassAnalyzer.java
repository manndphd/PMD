...
public class UndeserializeableClassAnalyzer extends RuleAnalyzer
{

	public UndeserializeableClassAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final TypeDeclaration typeDecl : typeDecls)
		{
			...
			final UndeserializeableClassChecker checker =
				new UndeserializeableClassChecker(parameter);
