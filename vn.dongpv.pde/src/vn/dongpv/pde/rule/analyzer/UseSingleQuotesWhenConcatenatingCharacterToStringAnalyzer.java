...
import vn.dongpv.pde.rule.checker.UseSingleQuotesWhenConcatenatingCharacterToStringChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class UseSingleQuotesWhenConcatenatingCharacterToStringAnalyzer extends RuleAnalyzer
{

	public UseSingleQuotesWhenConcatenatingCharacterToStringAnalyzer(
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final InfixExpression expression : expressions)
		{
			...
			final UseSingleQuotesWhenConcatenatingCharacterToStringChecker checker =
				new UseSingleQuotesWhenConcatenatingCharacterToStringChecker(parameter);
