...
import vn.dongpv.pde.rule.checker.AvoidCreatingThreadWithoutRunMethodChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidCreatingThreadWithoutRunMethodAnalyzer extends RuleAnalyzer
{

	public AvoidCreatingThreadWithoutRunMethodAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final ClassInstanceCreation creation : creations)
		{
			...
			final AvoidCreatingThreadWithoutRunMethodChecker checker =
				new AvoidCreatingThreadWithoutRunMethodChecker(parameter);
