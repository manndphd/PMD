...
import vn.dongpv.pde.rule.checker.BoxedPrimitiveJustCallToStringChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class BoxedPrimitiveJustCallToStringAnalyzer extends RuleAnalyzer
{

	public BoxedPrimitiveJustCallToStringAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final BoxedPrimitiveJustCallToStringChecker checker =
				new BoxedPrimitiveJustCallToStringChecker(parameter);
