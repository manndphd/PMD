...
import vn.dongpv.pde.rule.checker.AvoidUsingThreadYieldChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidUsingThreadYieldAnalyzer extends RuleAnalyzer
{

	public AvoidUsingThreadYieldAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final AvoidUsingThreadYieldChecker checker =
				new AvoidUsingThreadYieldChecker(parameter);
