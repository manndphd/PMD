...
import vn.dongpv.pde.rule.checker.FieldShouldBeStaticChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class FieldShouldBeStaticAnalyzer extends RuleAnalyzer
{

	public FieldShouldBeStaticAnalyzer(ASTNodeCollector collector) throws NullPointerException
	{
		super(collector);
	}
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final VariableDeclarationFragment fragment : fragments)
		{
			...
			final FieldShouldBeStaticChecker checker =
				new FieldShouldBeStaticChecker(parameter);
