...
import vn.dongpv.pde.rule.checker.AvoidInstantiationForGetClassChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidInstantiationForGetClassAnalyzer extends RuleAnalyzer
{

	public AvoidInstantiationForGetClassAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final ClassInstanceCreation creation : creations)
		{
			...
			final AvoidInstantiationForGetClassChecker checker =
				new AvoidInstantiationForGetClassChecker(parameter);
