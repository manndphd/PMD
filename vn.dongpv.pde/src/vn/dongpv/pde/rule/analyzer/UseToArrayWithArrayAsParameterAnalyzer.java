...
import vn.dongpv.pde.rule.checker.UseToArrayWithArrayAsParameterChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class UseToArrayWithArrayAsParameterAnalyzer extends RuleAnalyzer
{

	public UseToArrayWithArrayAsParameterAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final UseToArrayWithArrayAsParameterChecker checker =
				new UseToArrayWithArrayAsParameterChecker(parameter);
