...
import vn.dongpv.pde.rule.checker.EnsureEfficientIterationOverMapEntriesChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class EnsureEfficientIterationOverMapEntriesAnalyzer extends RuleAnalyzer
{

	public EnsureEfficientIterationOverMapEntriesAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final EnsureEfficientIterationOverMapEntriesChecker checker =
				new EnsureEfficientIterationOverMapEntriesChecker(parameter);
