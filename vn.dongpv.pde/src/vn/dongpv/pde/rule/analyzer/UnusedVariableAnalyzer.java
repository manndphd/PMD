...
import vn.dongpv.pde.rule.checker.UnusedVariableChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class UnusedVariableAnalyzer extends RuleAnalyzer
{

	public UnusedVariableAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final VariableDeclarationFragment fragment : fragments)
		{
			...
			final UnusedVariableChecker checker = new UnusedVariableChecker(parameter);
