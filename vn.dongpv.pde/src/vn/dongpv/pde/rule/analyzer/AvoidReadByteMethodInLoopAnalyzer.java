...
import vn.dongpv.pde.rule.checker.AvoidReadByteMethodInLoopChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidReadByteMethodInLoopAnalyzer extends RuleAnalyzer
{

	public AvoidReadByteMethodInLoopAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final AvoidReadByteMethodInLoopChecker checker =
				new AvoidReadByteMethodInLoopChecker(parameter);
