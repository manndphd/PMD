...
import vn.dongpv.pde.rule.checker.AvoidUsingStringTokenizerChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidUsingStringTokenizerAnalyzer extends RuleAnalyzer
{

	public AvoidUsingStringTokenizerAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final ClassInstanceCreation creation : creations)
		{
			...
			final AvoidUsingStringTokenizerChecker checker =
				new AvoidUsingStringTokenizerChecker(parameter);
