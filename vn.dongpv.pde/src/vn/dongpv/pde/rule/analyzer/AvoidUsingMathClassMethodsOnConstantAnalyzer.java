...
import vn.dongpv.pde.rule.checker.AvoidUsingMathClassMethodsOnConstantChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidUsingMathClassMethodsOnConstantAnalyzer extends RuleAnalyzer
{

	public AvoidUsingMathClassMethodsOnConstantAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation methodInvocation : methodInvocations)
		{
			...
			final AvoidUsingMathClassMethodsOnConstantChecker checker =
				new AvoidUsingMathClassMethodsOnConstantChecker(parameter);
