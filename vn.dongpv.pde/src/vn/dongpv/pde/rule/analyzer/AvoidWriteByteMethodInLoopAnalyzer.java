...
import vn.dongpv.pde.rule.checker.AvoidWriteByteMethodInLoopChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidWriteByteMethodInLoopAnalyzer extends RuleAnalyzer
{

	public AvoidWriteByteMethodInLoopAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final AvoidWriteByteMethodInLoopChecker checker =
				new AvoidWriteByteMethodInLoopChecker(parameter);
