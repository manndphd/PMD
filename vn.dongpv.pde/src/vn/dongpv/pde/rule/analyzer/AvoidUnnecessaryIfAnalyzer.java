...
import vn.dongpv.pde.rule.checker.AvoidUnnecessaryIfChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidUnnecessaryIfAnalyzer extends RuleAnalyzer
{

	public AvoidUnnecessaryIfAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final IfStatement ifStatement : ifStatements)
		{
			...
			final AvoidUnnecessaryIfChecker checker =
				new AvoidUnnecessaryIfChecker(parameter);
