...
import vn.dongpv.pde.rule.checker.AvoidEmptyCatchBlocksChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidEmptyCatchBlocksAnalyzer extends RuleAnalyzer
{

	public AvoidEmptyCatchBlocksAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final TryStatement tryStatement : tryStatements)
		{
			...
			final AvoidEmptyCatchBlocksChecker checker =
				new AvoidEmptyCatchBlocksChecker(parameter);
