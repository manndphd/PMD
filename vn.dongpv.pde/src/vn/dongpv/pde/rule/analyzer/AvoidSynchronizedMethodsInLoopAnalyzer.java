...
import vn.dongpv.pde.rule.checker.AvoidSynchronizedMethodsInLoopChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidSynchronizedMethodsInLoopAnalyzer extends RuleAnalyzer
{

	public AvoidSynchronizedMethodsInLoopAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final AvoidSynchronizedMethodsInLoopChecker checker =
				new AvoidSynchronizedMethodsInLoopChecker(parameter);
