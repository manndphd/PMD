...
import vn.dongpv.pde.rule.checker.DoNotImplementSerializableChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class DoNotImplementSerializableAnalyzer extends RuleAnalyzer
{

	public DoNotImplementSerializableAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final TypeDeclaration typeDecl : typeDecls)
		{
			...
			final DoNotImplementSerializableChecker checker =
				new DoNotImplementSerializableChecker(parameter);
