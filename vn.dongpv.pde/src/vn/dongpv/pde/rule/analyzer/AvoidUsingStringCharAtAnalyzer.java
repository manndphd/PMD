...
import vn.dongpv.pde.rule.checker.AvoidUsingStringCharAtChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidUsingStringCharAtAnalyzer extends RuleAnalyzer
{

	public AvoidUsingStringCharAtAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final AvoidUsingStringCharAtChecker checker =
				new AvoidUsingStringCharAtChecker(parameter);
