...
import vn.dongpv.pde.rule.checker.PlaceTryCatchOutOfLoopChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class PlaceTryCatchOutOfLoopAnalyzer extends RuleAnalyzer
{

	public PlaceTryCatchOutOfLoopAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final TryStatement tryStatement : tryStatements)
		{
			...
			final PlaceTryCatchOutOfLoopChecker checker =
				new PlaceTryCatchOutOfLoopChecker(parameter);
