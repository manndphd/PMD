...
import vn.dongpv.pde.rule.checker.NonFinalPublicStaticFieldChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class NonFinalPublicStaticFieldAnalyzer extends RuleAnalyzer
{

	public NonFinalPublicStaticFieldAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final FieldDeclaration fieldDecl : fieldDecls)
		{
			...
			final NonFinalPublicStaticFieldChecker checker =
				new NonFinalPublicStaticFieldChecker(parameter);
