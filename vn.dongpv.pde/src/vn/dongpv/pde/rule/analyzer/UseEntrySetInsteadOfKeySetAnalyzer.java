...
import vn.dongpv.pde.rule.checker.UseEntrySetInsteadOfKeySetChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class UseEntrySetInsteadOfKeySetAnalyzer extends RuleAnalyzer
{

	public UseEntrySetInsteadOfKeySetAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final UseEntrySetInsteadOfKeySetChecker checker =
				new UseEntrySetInsteadOfKeySetChecker(parameter);
