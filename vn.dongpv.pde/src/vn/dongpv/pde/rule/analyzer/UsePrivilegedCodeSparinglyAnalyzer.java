...
import vn.dongpv.pde.rule.checker.UsePrivilegedCodeSparinglyChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class UsePrivilegedCodeSparinglyAnalyzer extends RuleAnalyzer
{

	public UsePrivilegedCodeSparinglyAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final ClassInstanceCreation creation : creations)
		{
			...
			final UsePrivilegedCodeSparinglyChecker checker =
				new UsePrivilegedCodeSparinglyChecker(parameter);
