...
import vn.dongpv.pde.rule.checker.HardcodedPasswordChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class HardcodedPasswordAnalyzer extends RuleAnalyzer
{

	public HardcodedPasswordAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final HardcodedPasswordChecker checker =
				new HardcodedPasswordChecker(parameter);
