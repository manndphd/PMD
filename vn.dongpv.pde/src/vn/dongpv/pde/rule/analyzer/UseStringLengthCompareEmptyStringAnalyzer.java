...
import vn.dongpv.pde.rule.checker.UseStringLengthCompareEmptyStringChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class UseStringLengthCompareEmptyStringAnalyzer extends RuleAnalyzer
{

	public UseStringLengthCompareEmptyStringAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation methodInvocation : methodInvocations)
		{
			...
			final UseStringLengthCompareEmptyStringChecker checker =
				new UseStringLengthCompareEmptyStringChecker(parameter);
