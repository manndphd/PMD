...
import vn.dongpv.pde.rule.checker.UseStringEqualsIgnoreCaseChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class UseStringEqualsIgnoreCaseAnalyzer extends RuleAnalyzer
{

	public UseStringEqualsIgnoreCaseAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation methodInvocation : methodInvocations)
		{
			...
			final UseStringEqualsIgnoreCaseChecker checker =
				new UseStringEqualsIgnoreCaseChecker(parameter);
