...
import vn.dongpv.pde.rule.checker.CommandInjectionChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class CommandInjectionAnalyzer extends RuleAnalyzer
{

	public CommandInjectionAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation methodInvocation : methodInvocations)
		{
			...
			final CommandInjectionChecker checker =
				new CommandInjectionChecker(parameter);
