...
import vn.dongpv.pde.rule.checker.AvoidVectorElementAtInsideLoopChecker;
import vn.dongpv.pde.rule.checker.core.ConditionalChecker;

public class AvoidVectorElementAtInsideLoopAnalyzer extends RuleAnalyzer
{

	public AvoidVectorElementAtInsideLoopAnalyzer(ASTNodeCollector collector)
	...
	public List<ProblemItem> analyze()
	{
		...
		for (final MethodInvocation invocation : methodInvocations)
		{
			...
			final AvoidVectorElementAtInsideLoopChecker checker =
				new AvoidVectorElementAtInsideLoopChecker(parameter);
